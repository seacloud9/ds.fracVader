...
*/
Phaser.Filter.Nebula = function (gameP) {

    Phaser.Filter.call(this, gameP);
    ...
    this.fragmentSrc = [
        ...
        "mat3 m = mat3( 0.00,  0.90,  0.60, -0.90,  0.36, -0.48,-0.60, -0.48,  0.34 );",
        "float timeNew = time+46.0;",
        ...
        "{",
            ...
            "float f= fbm( p*1.0 - vec3(.4,0.3,-0.3)*timeNew);",
            "d += 4.0 * f;",
        ...
        "{",
            ...
            "if (s > 0.0)",
            "{",
                "vec3 backStars = vec3((1.0-sin(xy.x*20.0+timeNew*13.0*rd.x+xy.y*30.0))*.5*s,s, s); ",
                "col += backStars;",
            "}",
...
Phaser.Filter.Nebula.prototype = Object.create(Phaser.Filter.prototype);
Phaser.Filter.Nebula.prototype.constructor = Phaser.Filter.Nebula;

Phaser.Filter.Nebula.prototype.init = function (width, height, texture) {
