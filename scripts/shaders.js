        ...
        texture.audio.addEventListener("canplay", function() {
            ...
            if (me.mAudioContext != null) {
                ...
                if (me.mNoAudioMessageShowed == false) {
                    ...
                    doAlert(getCoords(ve), {
                        mX: 420,
                        mY: 160
                    }, "Error", "Your browser does not support WebAudio.<br><br>This shader will not work as the author intended. Please consider using a WebAudio-friendly browser (Chrome).", false, null);
        ...
        texture.keyboard.mImage.onload = function() {
            ...
            if (me.mTextureCallbackFun != null)
                me.mTextureCallbackFun(me.mTextureCallbackObj, slot, {
                    mImage: texture.keyboard.mImage,
                    mData: texture.keyboard.mData
                }, false, false, 4, -1.0);
        }
...
Effect.prototype.DetermineShaderPrecission = function() {
    ...
    if (this.CreateShader(h1 + str, false).mSuccess == true) {
        this.mPrecision = h1;
        return;
    }
    if (this.CreateShader(h2 + str, false).mSuccess == true) {
        this.mPrecision = h2;
        return;
    }
    if (this.CreateShader(h3 + str, false).mSuccess == true) {
        this.mPrecision = h3;
        return;
    }
    this.mPrecision = "";
...
Effect.prototype.PauseInput = function(id) {
    ...
    if (inp == null) {} else if (inp.mInfo.mType == "texture") {} else if (inp.mInfo.mType == "slideshow") {
...
Effect.prototype.UpdateInputs = function() {
    for (var i = 0; i < this.mInputs.length; i++) {
        ...
        if (inp == null) {} else if (inp.mInfo.mType == "texture") {} else if (inp.mInfo.mType == "slideshow") {} else if (inp.mInfo.mType == "video") {
        ...
        if (inp == null) {
            ...
            if (inp.loaded == false)
                ...
                if (inp.keyboard.mNewTextureReady == true) {
                    ...
                    if (this.mTextureCallbackFun != null)
                        this.mTextureCallbackFun(this.mTextureCallbackObj, i, {
                            mImage: inp.keyboard.mImage,
                            mData: inp.keyboard.mData
                        }, false, false, 4, -1.0);
                }
            }
...
Effect.prototype.newScriptJSON = function(jobj) {
    ...
    if (numPasses > 1) {
        return {
            mFailed: true,
            mError: "ShaderToy only supports one-pass shaders at this momment",
            mShader: null
        };
    }
