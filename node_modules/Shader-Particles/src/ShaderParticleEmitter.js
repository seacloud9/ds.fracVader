...
SPE.Emitter = function(options) {
    ...
    that.position = options.position instanceof SPE.THREE.Vector3 ? options.position : new SPE.THREE.Vector3();
    that.positionSpread = options.positionSpread instanceof SPE.THREE.Vector3 ? options.positionSpread : new SPE.THREE.Vector3();
    ...
    that.radiusScale = options.radiusScale instanceof SPE.THREE.Vector3 ? options.radiusScale : new SPE.THREE.Vector3(1, 1, 1);
    that.radiusSpreadClamp = typeof options.radiusSpreadClamp === 'number' ? options.radiusSpreadClamp : 0;

    that.acceleration = options.acceleration instanceof SPE.THREE.Vector3 ? options.acceleration : new SPE.THREE.Vector3();
    that.accelerationSpread = options.accelerationSpread instanceof SPE.THREE.Vector3 ? options.accelerationSpread : new SPE.THREE.Vector3();

    that.velocity = options.velocity instanceof SPE.THREE.Vector3 ? options.velocity : new SPE.THREE.Vector3();
    that.velocitySpread = options.velocitySpread instanceof SPE.THREE.Vector3 ? options.velocitySpread : new SPE.THREE.Vector3();
    ...
    // Colors
    that.colorStart = options.colorStart instanceof SPE.THREE.Color ? options.colorStart : new SPE.THREE.Color('white');
    that.colorStartSpread = options.colorStartSpread instanceof SPE.THREE.Vector3 ? options.colorStartSpread : new SPE.THREE.Vector3();

    that.colorEnd = options.colorEnd instanceof SPE.THREE.Color ? options.colorEnd : that.colorStart.clone();
    that.colorEndSpread = options.colorEndSpread instanceof SPE.THREE.Vector3 ? options.colorEndSpread : new SPE.THREE.Vector3();

    that.colorMiddle =
        options.colorMiddle instanceof SPE.THREE.Color ?
        options.colorMiddle :
        new SPE.THREE.Color().addColors(that.colorStart, that.colorEnd).multiplyScalar(0.5);
    that.colorMiddleSpread = options.colorMiddleSpread instanceof SPE.THREE.Vector3 ? options.colorMiddleSpread : new SPE.THREE.Vector3();
